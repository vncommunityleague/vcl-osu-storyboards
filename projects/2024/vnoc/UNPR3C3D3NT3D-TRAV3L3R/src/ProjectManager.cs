...
public class ProjectManager : StoryboardObjectGenerator
{
    ...
    [Configurable] public string ExcludeDirectories = "f, font";

    [Configurable] public string ExcludeFiles = "";

    [Configurable] public Destination ExportDestination = Destination.Mapset;

    [Configurable] public bool CleanDestinationDirectory = false;

    [Configurable] public bool Reload = true;
